# This script plots the traceplot (Figure 5 of the paper)
...
load("./Ranking_Data/5D/Traceplot_rank/T_S")
load("./Ranking_Data/5D/Traceplot_rank/T_K")
load("./Ranking_Data/5D/Traceplot_rank/T_B")
load("./Ranking_Data/5D/Traceplot_rank/T_A")
...
pdf(file = paste("./New_Figures/Figure_5.pdf",sep=""),width = 18,height = 12)
...
arrows(C_S,0.8,C_S,0.6,length = 0.1, col = "seagreen")
...
arrows(C_K,0.9,C_K,0.7,length = 0.1,col="purple")
...
arrows(C_B,0.8,C_B,0.6,length = 0.1,col="blue")
